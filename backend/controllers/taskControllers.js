...
exports.postTask = async (req, res) => {
  try {
    ...
    if (!title && !description) {
      return res.status(400).json({ status: false, msg: "Missing Title or Description" });
    }
...
exports.putTask = async (req, res) => {
  try {
    ...
    task = await Task.findByIdAndUpdate(req.params.taskId, { title, description, dueDate }, { new: true });
